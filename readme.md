...
> But they are other branches that use [Angular](https://github.com/jfmdev/ngAddressBook/tree/angular) and [AngularJS](https://github.com/jfmdev/ngAddressBook/tree/angularjs).
